...
exports.createSeedDb = createSeedDb;
    ...
    return {
        products: [
            withMeta({
                ...
                description: 'Multi-tenant AI sales agent that calls leads, qualifies them, books demos, and writes the CRM note — running on Indian telecom infrastructure with TRAI-compliant DLT.',
                features: [
            ...
            withMeta({
                ...
                description: 'Auto-generated weekly intelligence reports for B2B operators — fed by your CRM, ad accounts, and product analytics. Insights, not dashboards.',
                features: [
            ...
            withMeta({
                ...
                status: 'Building · Q3',
                tags: ['SEO', 'GEO', 'AEO'],
                description: 'Audit your visibility across the new search stack — Google, AI Overviews, ChatGPT, Perplexity, Gemini. One score. One action list.',
                features: [
            ...
            withMeta({
                ...
                description: 'Send a voice note. Get a polished, SEO-ready article published to your blog in minutes. Built for solo operators and small teams who think faster than they type.',
                features: [
