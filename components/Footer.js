        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <CheetahLogo className="w-10 h-10" />
              <div>
          ...
          <div className="lg:col-span-2">
            ...
            <form className="flex flex-col gap-2" action="/api/lead" method="POST">
              ...
              <input
                ...
                aria-label="Email"
              />
              <button type="submit" className="btn-strike justify-center !py-2.5 !text-xs">
                Subscribe →
              </button>
            </form>
          </div>
